      ...
      firebase
        ...
        .then(() => {
          ...
          userRef.add(FormData).then(() => {
              ...
              [
                {
                  text: 'OK',
                  onPress: () => {
                    // Quay về màn hình Login sau khi nhấn OK
                    navigation.navigate('Login');
                  },
                },
              ],
            ...
            console.log("Lỗi firestore",error);
        ...
        .catch(error => {
          ...
          if (
            ...
            setCustomError('Email không đúng');
          } else if (
            error.message ==
            ...
            error.message ==
            'Firebase: Passowrd should be at least 6 characters (auth/weak-password).'
          ) {
            setCustomError('Mật khẩu ít nhất 6 kí tự');
          } else {
